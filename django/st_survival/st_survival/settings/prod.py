...
SECRET_KEY = 'i$kt-$5f1@rh_a6g*%3b2q&i$*27!_a42baz)i3vg=+fp^v^rs'

# Add your site's domain name(s) here.
ALLOWED_HOSTS = ['st-s.scouthack.com']
...
DEFAULT_FROM_EMAIL = 'Star Trek: Survival <info@st-s.scouthack.com>'

# A list of people who get error notifications.
ADMINS = [
    ('Administrator', 'admin@st-s.scouthack.com'),
]
